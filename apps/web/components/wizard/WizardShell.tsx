...
export default function WizardShell({ wizard }: { wizard: RedAIWizard }) {
  const steps = { sources: SourcesStep, analyzing: AnalysisStep, brand: BrandStep, brief: CampaignBriefStep, planning: PlanningStep, strategy: StrategyStep, ideating: IdeasGenerationStep, ideas: IdeasStep, generatingContent: ContentGenerationStep, content: ContentReviewStep, production: ProductionStep, creatives: CreativeReviewStep, result: ResultStep };
